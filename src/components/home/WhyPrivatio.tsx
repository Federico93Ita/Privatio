...
const features = [
  ...
  },
  {
    ...
    description: "Un consulente dedicato ti accompagna in ogni fase, dalla prima pubblicazione fino al rogito notarile.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Il tuo annuncio pubblicato su Immobiliare.it, Idealista, Casa.it e tutti i principali portali italiani.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
