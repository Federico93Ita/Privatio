...
export default function PropertyGallery({ photos }: PropertyGalleryProps) {
  ...
  if (sorted.length === 0) {
    return (
      <div className="aspect-[16/9] rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col items-center justify-center text-slate-300">
        ...
        <span className="text-sm text-slate-400">Nessuna foto disponibile</span>
        <span className="text-xs text-slate-300 mt-1">Le foto verranno aggiunte a breve</span>
      </div>
    );
  }
