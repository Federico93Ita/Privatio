...
export default function PropertyGallery({ photos }: PropertyGalleryProps) {
  ...
  if (sorted.length === 0) {
    return (
      <div className="aspect-[16/9] rounded-2xl bg-gradient-to-br from-primary/5 via-bg-soft to-border flex flex-col items-center justify-center text-text-muted/50">
        <svg className="w-20 h-20 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={0.75}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.41a2.25 2.25 0 013.182 0l2.909 2.91m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
        </svg>
        <span className="text-sm font-medium text-text-muted">Foto non ancora disponibili</span>
        <span className="text-xs text-text-muted/60 mt-1">Le foto saranno disponibili a breve</span>
      </div>
    );
  }
