...
export default function PropertyGallery({ photos }: PropertyGalleryProps) {
  ...
  if (sorted.length === 0) {
    return (
      <div className="aspect-[16/9] rounded-2xl bg-gradient-to-br from-bg-soft to-border flex flex-col items-center justify-center text-text-muted/40">
        ...
        <span className="text-sm text-text-muted">Nessuna foto disponibile</span>
        <span className="text-xs text-text-muted/60 mt-1">Le foto verranno aggiunte a breve</span>
      </div>
    );
  }
