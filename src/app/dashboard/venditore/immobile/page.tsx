    ...
    return (
      <DashboardLayout role="seller">
        <div className="bg-white rounded-xl p-8 border border-[#e2e8f0] text-center">
          <h2 className="text-lg font-semibold text-[#0a1f44] mb-2">Nessun immobile</h2>
          <p className="text-[#64748b] mb-4">Non hai ancora inserito un immobile.</p>
          <Link href="/vendi" className="text-[#0e8ff1] hover:underline font-medium">
    ...
    <DashboardLayout role="seller">
      <div className="space-y-6 max-w-3xl">
        <div className="flex items-center justify-between">
          <div>
            <Link href="/dashboard/venditore" className="text-sm text-[#0e8ff1] hover:underline mb-2 inline-block">
              &larr; Torna alla Dashboard
            </Link>
            <h1 className="text-2xl font-bold text-[#0a1f44]">Modifica Immobile</h1>
        ...
        {isReadOnly && (
          <div className="bg-[#64748b]/10 border border-[#64748b]/30 rounded-xl p-4 text-sm text-[#64748b]">
        ...
        <div className="bg-white rounded-xl p-5 border border-[#e2e8f0] space-y-4">
          <h3 className="font-semibold text-[#0a1f44]">Informazioni</h3>
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span className="text-[#64748b]">Indirizzo</span>
              <p className="font-medium text-[#0a1f44]">{property.address}, {property.city}</p>
            </div>
          </div>
        </div>
        ...
        {!isReadOnly && (
          <div className="bg-white rounded-xl p-5 border border-[#e2e8f0] space-y-4">
            <h3 className="font-semibold text-[#0a1f44]">Dettagli modificabili</h3>

            <div>
              <label className="block text-sm font-medium text-[#1e293b] mb-1">Prezzo (EUR)</label>
              <input
                type="number"
                value={price}
            ...
            {!isPublished && (
              <>
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#1e293b] mb-1">Locali</label>
                    <input
                      type="number"
                      value={rooms}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#1e293b] mb-1">Bagni</label>
                    <input
                      type="number"
                      value={bathrooms}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#1e293b] mb-1">Superficie (m&sup2;)</label>
                    <input
                      type="number"
                      value={surface}
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#1e293b] mb-1">Piano</label>
                    <input
                      type="number"
                      value={floor ?? ""}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#1e293b] mb-1">Piani totali</label>
                    <input
                      type="number"
                      value={totalFloors ?? ""}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#1e293b] mb-1">Classe energetica</label>
                    <select
                      value={energyClass || ""}
                  ...
                  {[
                    ...
                    <label key={feat.label} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 rounded border-[#e2e8f0] text-[#0e8ff1] focus:ring-[#0e8ff1]"
                      />
                      <span className="text-sm text-[#1e293b]">{feat.label}</span>
                    </label>
                  ))}
                </div>
              </>
            ...
            {saved && <p className="text-sm text-[#10b981]">Modifiche salvate con successo!</p>}
