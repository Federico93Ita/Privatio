        ...
        <div style="font-family: Inter, Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px; background: white;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 8px 0; color: #64748b;">Email:</td><td style="padding: 8px 0;"><a href="mailto:${esc(email)}" style="color: #2563eb;">${esc(email)}</a></td></tr>
        ...
        <div style="font-family: Inter, Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 20px 30px; background: #f8fafc; text-align: center;">
            <p style="color: #94a3b8; font-size: 13px; margin: 0;">
              ...
              <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://privatio.it"}" style="color: #2563eb;">privatio.it</a>
            </p>
          </div>
        </div>
      `,
