            ...
            <div className="overflow-x-auto mt-2">
              <table className="w-full text-xs border border-border rounded">
                ...
                <tbody>
                  ...
                  <tr><td className="p-2 border-b border-border">Visibilit&agrave; profilo agenzia</td><td className="p-2 text-center border-b border-border">Standard</td><td className="p-2 text-center border-b border-border">Potenziata</td><td className="p-2 text-center border-b border-border">Prioritaria</td><td className="p-2 text-center border-b border-border">In evidenza</td></tr>
