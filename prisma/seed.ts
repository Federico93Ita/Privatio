...
async function main() {
  ...
  const realAdmin = await prisma.user.upsert({
    ...
    update: { role: "ADMIN", password: realAdminPassword, emailVerified: new Date() },
    create: {
  ...
  const miZones = [
    {
      ...
      slug: "milano-centro-storico",
      zoneClass: "PREMIUM" as const,
      region: "Lombardia",
      province: "MI",
      city: "Milano",
      capCodes: ["20121", "20122", "20123"],
      municipalities: ["Milano"],
      population: 85000,
      ntn: 1200,
      marketScore: 10,
      avgPricePerSqm: 8500,
      monthlyPrice: 259900, // €2.599/mese
      maxAgencies: 5,
      lat: 45.4642,
      lng: 9.1900,
      adjacentZoneIds: [] as string[],
    },
    {
      name: "Milano Navigli - Tortona",
      slug: "milano-navigli-tortona",
      zoneClass: "PREMIUM" as const,
      region: "Lombardia",
      province: "MI",
      city: "Milano",
      capCodes: ["20143", "20144"],
      municipalities: ["Milano"],
      population: 62000,
      ntn: 850,
      marketScore: 9,
    ...
    {
      name: "Milano Porta Nuova - Isola",
      slug: "milano-porta-nuova-isola",
      zoneClass: "PREMIUM" as const,
      region: "Lombardia",
      province: "MI",
      city: "Milano",
      capCodes: ["20124", "20159"],
      municipalities: ["Milano"],
      population: 48000,
      ntn: 780,
      marketScore: 9,
    ...
    {
      name: "Milano Città Studi - Lambrate",
      slug: "milano-citta-studi-lambrate",
      zoneClass: "URBANA" as const,
      region: "Lombardia",
      province: "MI",
      city: "Milano",
      capCodes: ["20132", "20133", "20134"],
      municipalities: ["Milano"],
      population: 95000,
      ntn: 620,
      marketScore: 7,
    ...
    {
      name: "Milano Bicocca - Niguarda",
      slug: "milano-bicocca-niguarda",
      zoneClass: "URBANA" as const,
      region: "Lombardia",
      province: "MI",
      city: "Milano",
      capCodes: ["20126", "20162"],
      municipalities: ["Milano"],
      population: 110000,
      ntn: 540,
      marketScore: 6,
    ...
    {
      name: "Milano San Siro - Fiera",
      slug: "milano-san-siro-fiera",
      zoneClass: "URBANA" as const,
      region: "Lombardia",
      province: "MI",
      city: "Milano",
      capCodes: ["20146", "20148", "20151"],
      municipalities: ["Milano"],
      population: 88000,
      ntn: 480,
      marketScore: 7,
    ...
    },
    {
      ...
      capCodes: ["20099"],
      municipalities: ["Sesto San Giovanni"],
      population: 81000,
      ntn: 420,
      marketScore: 6,
      avgPricePerSqm: 2800,
    ...
    {
      name: "Cinisello Balsamo - Cologno",
      slug: "cinisello-balsamo-cologno",
      zoneClass: "BASE" as const,
      region: "Lombardia",
      province: "MI",
      city: "Cinisello Balsamo",
      capCodes: ["20092", "20093"],
      municipalities: ["Cinisello Balsamo", "Cologno Monzese"],
      population: 120000,
      ntn: 380,
      marketScore: 5,
      avgPricePerSqm: 2200,
    ...
    },
    {
      ...
      province: "MI",
      city: "Rho",
      capCodes: ["20017", "20016"],
      municipalities: ["Rho", "Pero", "Pregnana Milanese"],
      population: 72000,
      ntn: 310,
      marketScore: 5,
      avgPricePerSqm: 2100,
    ...
    {
      name: "San Donato - San Giuliano",
      slug: "san-donato-san-giuliano",
      zoneClass: "BASE" as const,
      region: "Lombardia",
      province: "MI",
      city: "San Donato Milanese",
      capCodes: ["20097", "20098"],
      municipalities: ["San Donato Milanese", "San Giuliano Milanese"],
      population: 65000,
      ntn: 280,
      marketScore: 5,
      avgPricePerSqm: 2400,
  ...
  // Create zones and then set adjacency
  const createdZones: { id: string; slug: string }[] = [];
  for (const zoneData of miZones) {
    ...
    createdZones.push({ id: zone.id, slug: zone.slug });
  }

  // Set adjacency: centro <-> navigli <-> san siro, centro <-> porta nuova <-> bicocca, etc.
  const slugToId = Object.fromEntries(createdZones.map((z) => [z.slug, z.id]));
  const adjacencyMap: Record<string, string[]> = {
    "milano-centro-storico": ["milano-navigli-tortona", "milano-porta-nuova-isola", "milano-citta-studi-lambrate"],
    "milano-navigli-tortona": ["milano-centro-storico", "milano-san-siro-fiera", "san-donato-san-giuliano"],
    "milano-porta-nuova-isola": ["milano-centro-storico", "milano-bicocca-niguarda", "milano-citta-studi-lambrate"],
    "milano-citta-studi-lambrate": ["milano-centro-storico", "milano-porta-nuova-isola", "milano-bicocca-niguarda"],
    "milano-bicocca-niguarda": ["milano-porta-nuova-isola", "milano-citta-studi-lambrate", "sesto-san-giovanni"],
    "milano-san-siro-fiera": ["milano-navigli-tortona", "rho-pero"],
    "sesto-san-giovanni": ["milano-bicocca-niguarda", "cinisello-balsamo-cologno"],
    "cinisello-balsamo-cologno": ["sesto-san-giovanni", "milano-bicocca-niguarda"],
    "rho-pero": ["milano-san-siro-fiera"],
    "san-donato-san-giuliano": ["milano-navigli-tortona", "milano-citta-studi-lambrate"],
  };

  for (const [slug, adjSlugs] of Object.entries(adjacencyMap)) {
    const id = slugToId[slug];
    const adjIds = adjSlugs.map((s) => slugToId[s]).filter(Boolean);
    if (id && adjIds.length > 0) {
      await prisma.zone.update({
        where: { id },
        data: { adjacentZoneIds: adjIds },
      });
    }
  }
  console.log(`${miZones.length} zones created for Milano (MI) with adjacency`);
